...
export const Obstacles = ObjectDefinitions.create<ObstacleDefinition>()(
    ...
    apply => [
        ...
        },
        {
            ...
            indestructible: true,
            hitbox: new HitboxGroup(
                new CircleHitbox(14, Vec.create(0, 0)), // Large circle hitbox
                new CircleHitbox(5, Vec.create(-8, 1.8)), // Small circle hitbox 1
                new CircleHitbox(5, Vec.create(-8, -1.8)), // Small circle hitbox 2
                new CircleHitbox(5, Vec.create(8, 1.8)), // Small circle hitbox 3
                new CircleHitbox(5, Vec.create(8, -1.8)) // Small circle hitbox 4
            ),
